...
concommand.Add( "cfc_forms_contact", openContactForm )
concommand.Add( "cfc_forms_feedback", openFeedbackForm )
concommand.Add( "cfc_forms_bugreport", openBugReportForm )
concommand.Add( "cfc_forms_playerreport", openPlayerReportForm )
concommand.Add( "cfc_forms_freezereport", openFreezeReportForm )
concommand.Add( "cfc_forms_staffreport", openStaffReportForm )
